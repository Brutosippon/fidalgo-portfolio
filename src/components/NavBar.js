...
export const NavBar = () => {
  ...
  //se fizermos scroll a imagem vai ficar transparente caso tivermos imagens no banner principal
  useEffect(() => {
    const onScroll = () => {
  ...
  //criar uma função para quando damos click em home, habilidades ou projectos
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <span className="navbar-text">
            ...
            {/*<button className="vvd" onClick={() => console.log('connect')}><span>Contacto</span></button>*/}
          </span>
        </Navbar.Collapse>
      </Container>
    </Navbar>
